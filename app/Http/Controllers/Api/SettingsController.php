...
class SettingsController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'strategy_trending_limit'   => 'sometimes|integer|min:1|max:50',
            'strategy_volume_enabled'   => 'sometimes|boolean',
            'strategy_volume_limit'     => 'sometimes|integer|min:1|max:50',
            'strategy_early_enabled'    => 'sometimes|boolean',
            'strategy_early_limit'      => 'sometimes|integer|min:1|max:50',
            'strategy_reversal_enabled' => 'sometimes|boolean',
            'strategy_reversal_limit'   => 'sometimes|integer|min:1|max:50',
        ]);
