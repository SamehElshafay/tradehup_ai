...
class PaperTrade extends Model {
    protected $fillable = [
        ...
        'exit_price', 'quantity', 'tp1', 'tp2', 'tp3', 'sl', 'pnl',
        'pnl_percent', 'status', 'opened_at', 'closed_at', 'close_target', 'history', 'highest_target_hit'
    ];
    protected $casts = [
        'entry_price' => 'float', 'exit_price' => 'float', 'quantity' => 'float',
        'tp1' => 'float', 'tp2' => 'float', 'tp3' => 'float', 'sl' => 'float',
        'pnl' => 'float', 'pnl_percent' => 'float',
        'opened_at' => 'datetime', 'closed_at' => 'datetime', 'history' => 'array'
    ];
